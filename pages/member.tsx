        ...
        <section className={styles.host} id="yukiue">
          ...
          <div className={styles.host__sugioka}>
            <Person name="Sugioka"
              ...
              othersOn
              othersTitle="スギちゃんのオールナイトドリーマー（仮）へ"
              text={
                <>
                  <p>
                    20代前半のO型。<br />
                  ...
                  <p>現在は日本最高学府において法学を学びつつ、部活やアイドルのライブ参加など精力的に活動中。</p>
                  <p>個人ブログ「スギちゃんのオールナイトドリーマー（仮）」では、好きなアイドルの話を中心に、さまざまな話題について首を突っ込んだり引っ込めたりする予定。</p>
                </>
              }
            >
              <ProfileSugioka />
